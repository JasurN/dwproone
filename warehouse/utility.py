...
def get_roll_id_and_instance_number(paper_producer_id, paper):
    ...
    try:
        ...
        return f'{paper_producer.short_name}{paper[0].paper_format.format}{str(today.year)[-2:]}0{today.month}{roll.instance_number + 1}', \
               roll.instance_number + 1
    except IndexError:
        return f'{paper_producer.short_name}{paper[0].paper_format.format }{str(today.year)[-2:]}0{today.month}1', 1
