...
from sales.tests.sales_test_utilites import create_customers, create_user, create_boxes, create_contract
from sales.views import CustomerListView, BoxListCreateView, ContractListCreateView


class CustomerListViewTestCase(TestCase):
    @classmethod
    def setUpTestData(cls):
        create_customers(number_customers=10, name='Customer')
        create_user()
